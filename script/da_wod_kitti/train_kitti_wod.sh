...
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Code/Segmentation/T-UDA/logs/train_uda_kitti_wod_T1_1_S0_0_%j.log
# module
...
python train_uda.py configs/data_config/da_wod_kitti/uda_kitti_wod.yaml --distributed False --ssl False
